 ...
 */
function tooba_setup() {
	load_theme_textdomain( 'tooba' );
...
function tooba_fonts_url() {
	...
	if ( 'off' !== $libre_franklin ) {
		...
		$font_families = array( 'Libre Franklin:300,300i,400,400i,600,600i,800,800i', 'Poppins:300,400,500,600,700' );
